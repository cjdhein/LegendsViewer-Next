...
public class ProcessionCollection : EventCollection, IHasComplexSubtype
{
        ...
        : base(properties, world)
    {
        ...
        Name = $"{Formatting.AddOrdinal(Ordinal)} procession";
        Icon = HtmlStyleUtil.GetIconString("human-queue");
    }
    ...
    public override string ToLink(bool link = true, DwarfObject? pov = null, WorldEvent? worldEvent = null)
    {
        if (link)
        {
            ...
            linkedString += pov != this
                ? HtmlStyleUtil.GetAnchorString(Icon, "procession", Id, title, Name)
