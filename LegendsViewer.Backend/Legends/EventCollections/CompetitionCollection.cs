...
public class CompetitionCollection : EventCollection, IHasComplexSubtype
{
        ...
        : base(properties, world)
    {
        ...
        Name = $"{Formatting.AddOrdinal(Ordinal)} competition";
        Icon = HtmlStyleUtil.GetIconString("trophy-outline");
    }
    ...
    public override string ToLink(bool link = true, DwarfObject? pov = null, WorldEvent? worldEvent = null)
    {
        if (link)
        {
            ...
            linkedString += pov != this
                ? HtmlStyleUtil.GetAnchorString(Icon, "competition", Id, title, Name)
