...
{
    public static readonly Dictionary<string, SkillDescription> Dict = new()
    {
        ...
        {"Detailstone", new SkillDescription("stn", "DETAILSTONE", "Detailer", "Engraving")},
        {"Carve Stone", new SkillDescription("stn", "CARVE_STONE", "Carver", "Engraving")},
        {"Engrave Stone", new SkillDescription("stn", "ENGRAVE_STONE", "Engraver", "Engraving")},
        {"Cut Stone", new SkillDescription("stn", "CUT_STONE", "Stonecutter", "Masonry")},
    ...
    {
        SkillDescription desc = new("unk", skill.Name, skill.Name, skill.Name);
